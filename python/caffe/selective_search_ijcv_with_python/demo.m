...
%%
addpath('/Users/thomas.law/Projects/caffe/python/caffe/selective_search_ijcv_with_python/Dependencies');
...
% if(~exist('anigauss'))
    ...
    mex /Users/thomas.law/Projects/caffe/python/caffe/selective_search_ijcv_with_python/Dependencies/anigaussm/anigauss_mex.c /Users/thomas.law/Projects/caffe/python/caffe/selective_search_ijcv_with_python/Dependencies/anigaussm/anigauss.c -output anigauss
% end

% if(~exist('mexCountWordsIndex'))
    mex /Users/thomas.law/Projects/caffe/python/caffe/selective_search_ijcv_with_python/Dependencies/mexCountWordsIndex.cpp
% end
...
%     fprintf('   
    mex -compatibleArrayDims /Users/thomas.law/Projects/caffe/python/caffe/selective_search_ijcv_with_python/Dependencies/FelzenSegment/mexFelzenSegmentIndex.cpp -output mexFelzenSegmentIndex;
% end
