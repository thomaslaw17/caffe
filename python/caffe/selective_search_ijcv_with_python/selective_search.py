...
def get_windows(image_fnames, cmd='selective_search'):
    ...
    mc = "matlab -nojvm -r \"addpath('/Users/thomas.law/Projects/caffe/python/caffe/selective_search_ijcv_with_python'); try; {}; catch; exit; end; exit\"".format(command)
    ...
    all_boxes = list(scipy.io.loadmat("/var/folders/7g/pw38zdbd08z_k1q977b25j140000gn/T/tmpDEk7rL.mat")['all_boxes'][0])
